    ...
    <article className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-gray-700 max-w-2xl">
          Play “Pick One” — a fast, fun multiple-choice game with core verbs, essential phrasal verbs, and each episode deck. Choose a set and beat your streak over 10 speedy rounds. 🎯
        </p>
      </header>
